#choose Maximum and Minimum and then line
...
#Inputs
PED, DI, PES, SI, MP, Type = float(input("Enter PED (Negative): ")),float(input("Enter Demand Intercept With Y Axis (Positive): ")),float(input("Enter PES (Positive): ")),float(input("Enter Supply Intercept With Y Axis (Either): ")),float(input("Enter Maximum or Minimum Price: ")),float(input("Enter 'max' or 'min': "))
